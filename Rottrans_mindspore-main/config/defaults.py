...
_C.DATASETS.NAMES = ('prai1581')
# Folder name of dataset prai1581
# _C.DATASETS.FOLDERNAMES = ('PRAI-1581AllTrain')
_C.DATASETS.FOLDERNAMES = ('PRAI-1581')

# Root directory where datasets should be used (and downloaded if not found)
_C.DATASETS.ROOT_DIR = ('/data1/lj_data/ReIDData/')
